...
\begin{table}[H]
   ...
   \resizebox{\textwidth}{!}{%
      ...
      Verfahren             & $n$    & abs. Fehler in $y_1$   & abs. Fehler in $y_2$   & abs. Fehler in $y_3$   \\ \hline
      Expliziter Euler      & $2048$ & $0.1191 \cdot 10^{-5}$ & $0.0000 \cdot 10^{-5}$ & $0.1191 \cdot 10^{-5}$ \\ \hline
      Mittelpunktsregel     & $2048$ & $0.2961 \cdot 10^{-5}$ & $0.3075 \cdot 10^{-5}$ & $0.0114 \cdot 10^{-5}$ \\ \hline
      Impliziter Euler      & $32$   & $0.7404 \cdot 10^{-4}$ & $0.0001 \cdot 10^{-4}$ & $0.7406 \cdot 10^{-4}$ \\ \hline
...
\begin{table}[H]
   ...
   \resizebox{\textwidth}{!}{%
      \begin{tabular}{l|l|l|l|l}
      Verfahren             & $n$      & abs. Fehler in $y_1$   & abs. Fehler in $y_2$   & abs. Fehler in $y_3$   \\ \hline
      Expliziter Euler      & $8192$   & $0.2978 \cdot 10^{-6}$ & $0.0000 \cdot 10^{-6}$ & $0.2978 \cdot 10^{-6}$ \\ \hline
      Mittelpunktsregel     & $16384$  & $0.3852 \cdot 10^{-6}$ & $0.4262 \cdot 10^{-6}$ & $0.0411 \cdot 10^{-6}$ \\ \hline
      Impliziter Euler      & $4096$   & $0.5954 \cdot 10^{-6}$ & $0.0001 \cdot 10^{-6}$ & $0.5955 \cdot 10^{-6}$ \\ \hline
